...
public class MainActivity extends AppCompatActivity implements MovieFragment.Callback, FavoriteFragment.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Start MovieFragment if savedInstanceState is null and pass bundle so that
        // Popular Movies page opens on app open
//        if (savedInstanceState == null){
//            MovieFragment movieFragment = new MovieFragment();
//            Bundle bundle = new Bundle();
//            bundle.putString(getString(R.string.sort_preference_key), "popular");
...
//
//            // open a new MovieFragment (most popular)
//            getFragmentManager().beginTransaction().add(R.id.detail_container, movieFragment).commit();
//        }
    }
...
//            editor.putString(getString(R.string.sort_preference_key), "top_rated");
//            editor.apply();
//            getFragmentManager().beginTransaction().replace(R.id.movie_fragment, new MovieFragment()).commit();
...
//            SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
//            SharedPreferences.Editor editor = preferences.edit();
//            editor.putString(getString(R.string.sort_preference_key), "popular");
//            editor.apply();
//            getFragmentManager().beginTransaction().replace(R.id.movie_fragment, new MovieFragment()).commit();
...
//            SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(this);
//            SharedPreferences.Editor editor = preferences.edit();
//            editor.putString(getString(R.string.sort_preference_key), "favorite");
//            editor.apply();
//            getFragmentManager().beginTransaction().replace(R.id.movie_fragment, new FavoriteFragment()).commit();
